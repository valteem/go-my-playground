...
func itemCreate(w http.ResponseWriter, r *http.Request) {
	...
	// r.Body() has bufio.Reader() under the hood, and it has already read all headers
	// (until \r\n\r\n) and waits to read the rest
...
func main() {
	...
	err := http.ListenAndServe(":44579", mux)
	log.Fatal(err)
}
